...
private:
	...
	ULONG_PTR			m_gdipToken;			// the GDI+ token
	HHOOK				m_hMouseHook;			// handle to the mouse hook structure
	BOOL				m_isMouseOver;			// whether the mouse is over the deskband
	BOOL				m_isMouseDown;			// whether the mouse button is down while over the deskband
};
